...
<div class="container-fluid">
    <div class="page-header">
        <div class="row">
            <div class="col-md-6">
                <h3 class="mb-2">Penambahan Surat Keluar</h3>
                <ol class="breadcrumb">
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form class="form theme-form" action="{{ route('outgoing-mail.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-8">
                                <input class="datepicker-here form-control digits" type="text" data-language="en" name="mail_incoming_date" required>
                            </div>
                        </div>
